...
from core.views import TestAPIVew,PosterListAPIView,PosterCreateAPIView,PosterRetriewAPIView,PosterUpdateAPIView,PosterDeleteAPIView,PosterDeleteAPIView
urlpatterns = [
    path('admin/', admin.site.urls),

    # path('test',Test.test_method,name='test')
    path('test',TestAPIVew.as_view(),name='test'),
    path('',PosterListAPIView.as_view(),name='poster_list'),
    path('create/poster',PosterCreateAPIView.as_view(),name='poster-create'),
    path('poster/<int:pk>',PosterRetriewAPIView.as_view()),
